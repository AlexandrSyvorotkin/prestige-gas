    ...
    return (
        <footer className={styles.footer}>
            <Container>
                ...
                <p className={styles.footer_text}>2020 © Инженерный центр "ТимСтрой" оказывает полный спектр услуг по реализации различных инженерных систем. Все правы защищены</p>
            </Container>
        </footer>
    );
};
